<%@ Page Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="Manage.aspx.cs" Inherits="trunstores_Manage" Title="" %>
...
<div class="pageTitle" style="font-size:14px;"><b>管理库存调拨</b></div>

<div class="pageColumn">      
    <table style="width: 100%;" cellpadding="2" cellspacing="1" class="border">
    <tr>
        <td align="center" class="tdbg">
<strong> 调拔单号:</strong><asp:TextBox ID="txt_tno" runat="server" width="150"></asp:TextBox>
<strong> 调出仓库</strong><asp:DropDownList ID="ddldno1" runat="server" Width="150"></asp:DropDownList>
<strong> 调入仓库</strong><asp:DropDownList ID="ddldno2" runat="server" Width="150"></asp:DropDownList>
<strong> 物资编号</strong><asp:DropDownList ID="ddlgno" runat="server" Width="150">
</asp:DropDownList>
...
<%# Container.ItemIndex+1 %></td>
 <td align="center"><%# Eval("tno")%></td>
 <td align="center"><%# Eval("dno1")%></td>
 <td align="center"><%# Eval("dno2")%></td>
...
<td align="center">
    <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="../images/ico_del.gif" ToolTip="删除该记录"  OnClick="del_Click"  CommandArgument='<%# Eval("tno") %>' OnClientClick='return confirm("您确定要删除此信息么？");' />
</td>
</tr>
    </ItemTemplate>
    </asp:Repeater>
