<%@ Page Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="Add.aspx.cs" ValidateRequest="false" Inherits="trunstores_Add" Title="" %>
...
<div class="pageTitle" style="font-size:14px;"><b>添加库存调拨</b></div>
...
<asp:TextBox ID="txt_tno" runat="server" width="200" Enabled="false"></asp:TextBox></div><div id="ctl00_ContentPlaceHolder1_txt_tnoTip" style="width:250px;display:inline;float:left;text-align:left;"></div>
 </td></tr>

<tr>
<td  style=" text-align:right; width:20%;">调出仓库:</td>
<td class="tbright"><div style="display:inline;float:left;">
<asp:DropDownList ID="ddldno1" runat="server" Width="200" AutoPostBack="True" OnSelectedIndexChanged="ddldno1_SelectedIndexChanged" >
</asp:DropDownList> </td></tr>

<tr>
<td  style=" text-align:right; width:20%;">调入仓库:</td>
<td class="tbright"><div style="display:inline;float:left;">
<asp:DropDownList ID="ddldno2" runat="server" Width="200" >
</asp:DropDownList></div><div id="ctl00_ContentPlaceHolder1_txt_dno2Tip" style="width:250px;display:inline;float:left;text-align:left;"></div>
 </td></tr>
