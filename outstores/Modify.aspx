<%@ Page Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="Modify.aspx.cs" Inherits="outstores_Modify" ValidateRequest="false" Title="" %>
...
<div class="pageTitle" style="font-size:14px;"><b>修改物资出库</b></div>
...
<asp:TextBox ID="txt_oid" runat="server" width="200"></asp:TextBox></div><div id="ctl00_ContentPlaceHolder1_txt_oidTip" style="width:250px;display:inline;float:left;text-align:left;"></div>
 </td></tr>
