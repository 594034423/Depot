<%@ Page Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="Manage.aspx.cs" Inherits="instore_Manage" Title="" %>
...
<div class="pageTitle" style="font-size:14px;"><b>管理物资入库</b></div>

<div class="pageColumn">      
    <table style="width: 100%;" cellpadding="2" cellspacing="1" class="border">
    <tr>
        <td align="center" class="tdbg">
<strong> 入库单号:</strong><asp:TextBox ID="txt_ino" runat="server" width="150"></asp:TextBox>
...
<%# Container.ItemIndex+1 %></td>
 <td align="center"><%# Eval("ino")%></td>
 <td align="center"><%# Eval("gname")%></td>
 <td align="center"><%# Eval("dno")%></td>
 <td align="center"><%# Eval("quantiy")%></td>
 <td align="center"><%# Eval("opname")%></td>
 <td align="center"><%# Eval("indate")%></td>

<td align="center">
    <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="../images/ico_del.gif" ToolTip="删除该记录"  OnClick="del_Click"  CommandArgument='<%# Eval("ino") %>' OnClientClick='return confirm("您确定要删除此信息么？");' />
</td>
</tr>
    </ItemTemplate>
    </asp:Repeater>
