<%@ Page Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="Manage.aspx.cs" Inherits="depot_Manage" Title="" %>
...
<div class="pageTitle" style="font-size:14px;"><b>管理仓库</b></div>
...
<%# Container.ItemIndex+1 %></td>
 ...
 <td align="center"><%# Eval("dquantity")%></td>
 <td align="center"><%# Eval("lquantity")%></td>

<td align="center">
    <a href="Modify.aspx?id=<%# Eval("dno") %>"><img src="../images/ico_edit.gif" width="16" height="16" style="border:0px;" title="修改该记录" /></a> 
    <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="../images/ico_del.gif" ToolTip="删除该记录"  OnClick="del_Click"  CommandArgument='<%# Eval("dno") %>' OnClientClick='return confirm("您确定要删除此信息么？");' />
</td>
</tr>
    </ItemTemplate>
    </asp:Repeater>
